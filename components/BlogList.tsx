  ...
  return (
    <div className="">
        ...
        <div className="group flex flex-col">
            ...
            <Image
                  className="object-cover object-left lg:object-center drop-shadow-xl 
                    ...
                    <div>
                        ...
                        <div className="flex flex-col md:flex-row gap-y-2 md: gap-x-2 items-center">
                            {post.categories.map((category) => (
                                <div className="bg-gray-400 text-center text-black px-3 py-1 rounded-full text-sm font-semibold">
                                    <p>{category.title}</p>
                                </div>
                            ))}                        
                    </div>
            ...
            <div className="mt-5 flex-1 ">
                ...
                <p className="line-clamp-2 text-gray-400 text-lg">{post.description}</p>
                </div>
